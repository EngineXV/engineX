...
Set ENGINE_TEST_LLM_MODE=mock for fast, deterministic, no-API tests.
Set ENGINE_TEST_LLM_MODEL=<model> to override the real model.
"""
...
USE_MOCK_LLM = os.environ.get("ENGINE_TEST_LLM_MODE", "mock").lower() == "mock"
LLM_MODEL = os.environ.get("ENGINE_TEST_LLM_MODEL", "cerebras/zai-glm-4.7")
