...
from engine.runtime.event_bus import AgentEvent
from engine.tui.widgets.log_pane import format_event, format_python_log
from engine.tui.widgets.selectable_rich_log import SelectableRichLog as RichLog
...
""")
    ...
    async def _cmd_attach(self, file_path: str | None = None) -> None:
        ...
        if file_path is None:
            from engine.tui.widgets.file_browser import _has_gui, pick_pdf_file
