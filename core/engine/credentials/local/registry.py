...
from engine.credentials.models import CredentialIdentity, CredentialObject
from engine.credentials.storage import EncryptedFileStorage

from .models import LocalAccountInfo

if TYPE_CHECKING:
    from engine_tools.credentials.health_check import HealthCheckResult
...
class LocalCredentialRegistry:
    ...
    def validate_account(self, credential_id: str, alias: str) -> HealthCheckResult:
        ...
        from engine_tools.credentials.health_check import HealthCheckResult, check_credential_health
    ...
    def default(cls) -> LocalCredentialRegistry:
        """Create a registry using the default encrypted storage at"""
