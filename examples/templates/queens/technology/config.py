"""Runtime configuration for Alexandra — Technology Supervisor."""
...
class AgentMetadata:
    name: str = "Alexandra"
    version: str = "1.0.0"
    description: str = "Technology department supervisor — supervises agreement analysis for vendor, SaaS, and tech partnerships."
    intro_message: str = (
