...
class AgentMetadata:
    ...
    intro_message: str = "Hi, I'm Catherine, Head of Marketing. Send a partnership or sponsorship agreement and I'll handle the analysis."
    supervisor: bool = True
    supervisor_name: str = "Catherine"
    department: str = "Marketing"
    role_title: str = "Head of Marketing"
    domain_focus: str = (
        "marketing partnerships, sponsorship deals, and brand collaborations"
    )
