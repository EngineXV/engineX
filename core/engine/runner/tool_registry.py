...
class ToolRegistry:
    ...
    def load_mcp_config(self, config_path: Path) -> None:
        ...
        self._mcp_engine_sync_key_snapshot = os.environ.get("ENGINE_OAUTH_API_KEY")
    ...
    def resync_mcp_servers_if_needed(self) -> bool:
        ...
        current_engine_sync_key = os.environ.get("ENGINE_OAUTH_API_KEY")
        files_changed = current != self._mcp_cred_snapshot
        oauth_api_key_changed = current_engine_sync_key != self._mcp_engine_sync_key_snapshot
