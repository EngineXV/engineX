...
Extract contract fields with **human-in-the-loop** approval and audit trail.
...
| Node | Type | Purpose |
|------|------|---------|
| intake | client-facing | Collect contract text |
...
```bash
./engine run examples/templates/contract_review \
