...
def load_engine_sync_api_key() -> str | None:
    ...
    key = _read_engine_sync_from_encrypted_store()
    if key:
...
def save_engine_sync_api_key(key: str) -> None:
...
def _read_engine_sync_from_encrypted_store() -> str | None:
