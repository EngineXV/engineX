...
from engine.llm.stream_events import StreamEvent

logger = logging.getLogger(__name__)


def _patch_litellm_anthropic_oauth() -> None:
    """Patch litellm's Anthropic header construction to fix OAuth token"""
    try:
...
FAILED_REQUESTS_DIR = Path.home() / ".engine" / "failed_requests"
