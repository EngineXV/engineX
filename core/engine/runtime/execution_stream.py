...
from engine.graph.executor import ExecutionResult, GraphExecutor
from engine.runtime.event_bus import EventBus
from engine.runtime.shared_state import IsolationLevel, SharedStateManager
from engine.runtime.stream_runtime import StreamRuntime, StreamRuntimeAdapter
...
class ExecutionAlreadyRunningError(RuntimeError):
    """Raised when attempting to start an execution on a stream"""
...
class ExecutionStream:
    ...
    def agent_idle_seconds(self) -> float:
        """Seconds since the last agent activity"""
        ...
        async with self._semaphore:
            ...
            try:
                ...
                if self._runtime_log_store:
                    from engine.runtime.runtime_logger import RuntimeLogger
    ...
    async def _write_session_state(
        ...
        from engine.schemas.session_state import SessionState, SessionStatus
