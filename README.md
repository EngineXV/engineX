...
Extended product and deployment guides live in the local `docs/` directory (gitignored — not published on GitHub). Clone or maintain that folder separately for internal use.
