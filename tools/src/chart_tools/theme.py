"""Engine ECharts theme — brand palette + cozy spacing defaults.
...
`echarts.registerTheme('engine', themeObj)` before `echarts.init`.
"""
...
# Engine brand palette — categorical, alternating warm/cool for
...
def build_theme(theme: str = "light") -> dict:
    """Return the Engine ECharts theme dict for the given mode.
