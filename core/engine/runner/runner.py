...
class AgentRunner:
    ...
    def _resolve_default_model() -> str:
        """Resolve the default model from ~/.engine/configuration.json"""
    ...
    def __init__(
        ...
        # Load ENGINE_CREDENTIAL_KEY from shell config if not in env.
        ...
        os.environ["ENGINE_AGENT_NAME"] = agent_path.name
        os.environ["ENGINE_STORAGE_PATH"] = str(self._storage_path)
    ...
    def _import_agent_module(agent_path: Path):
        ...
        # when another thread modifies sys.modules concurrently.
        module_keys = list(sys.modules)
        stale = [
            name
    ...
    def load(
        ...
        if agent_py.exists():
            ...
            if agent_config and hasattr(agent_config, "max_tokens"):
                ...
                max_tokens = engine_config.get("llm", {}).get("max_tokens", DEFAULT_MAX_TOKENS)
    ...
    def _setup(self, event_bus=None) -> None:
        ...
        if has_loop_nodes:
            from engine.graph.files import FILES_MCP_SERVER_CONFIG, FILES_MCP_SERVER_NAME
        ...
        try:
            from engine_tools.credentials.store_adapter import CredentialStoreAdapter
    ...
    def _get_api_key_env_var(self, model: str) -> str | None:
        ...
        elif model_lower.startswith("zai/"):
            return "ZAI_API_KEY"
        else:
    ...
    def _get_api_key_from_credential_store(self) -> str | None:
        ...
        if not os.environ.get("ENGINE_CREDENTIAL_KEY"):
            return None
    ...
    def _setup_agent_runtime(
        ...
        if self.runtime_config is not None:
            from engine.runtime.agent_runtime import AgentRuntimeConfig
    ...
    def validate(self) -> ValidationResult:
        ...
        # Uses CredentialStoreAdapter.default() which includes Engine sync support
        missing_credentials = []
        try:
            from engine_tools.credentials.store_adapter import CredentialStoreAdapter
