...
from engine.schemas.decision import Decision, DecisionType, Option, Outcome
from engine.schemas.run import Run, RunStatus
...
class StreamRuntimeAdapter:
    """Adapter to make StreamRuntime compatible"""
