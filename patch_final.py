#!/usr/bin/env python3
"""Cleanly integrate LLM response cache into LiteLLMProvider."""
filepath = 'core/engine/llm/litellm.py'
with open(filepath) as f:
    lines = f.readlines()

# Remove any previously added lines (import, cache init, checks, stores)
...
for line in lines:
    ...
    # --- 3. Insert cache check after docstring of complete() ---
    ...
    # --- 5. Insert cache check after docstring of acomplete() ---
