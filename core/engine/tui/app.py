...
from engine.tui.widgets.selectable_rich_log import SelectableRichLog
...
class EngineTUI(App):
    ...
    def _mount_agent_widgets(self) -> None:
        ...
        from engine.tui.widgets.chat_repl import ChatRepl
        from engine.tui.widgets.graph_view import GraphOverview
    ...
    def _show_account_selection(self, runner, accounts: list[dict]) -> None:
        ...
        from engine.tui.screens.account_selection import AccountSelectionScreen
    ...
    def _show_credential_setup(
        ...
        from engine.tui.screens.credential_setup import CredentialSetupScreen
    ...
    def _show_agent_picker_initial(self) -> None:
        ...
        from engine.tui.screens.agent_picker import AgentPickerScreen, discover_agents
